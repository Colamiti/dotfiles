...
alias idea='/home/colin/intelj/ideaIC-2023.1/idea-IC-231.8109.175/bin/idea.sh'

# Define the marco function
marco () {
    export MARCO_DIR=$(pwd)  # Save the current working directory to an environment variable
}

# Define the polo function
polo () {
    cd "$MARCO_DIR"  # Change the directory to the one saved in the MARCO_DIR environment variable
}
. "$HOME/.cargo/env"
xmodmap -e "clear lock" -e "keycode 66 = Escape"
alias ..='cd ..'
source /home/colin/alacritty/extra/completions/alacritty.bash
